...
export function AudioRecorder({ audioState, onStateChange, isMobile }: AudioRecorderProps) {
        ...
        {!audioState.audioBlob ? (
          ...
          <div className="flex flex-col items-center space-y-4">
            <button
              ...
              className={`${isMobile ? 'w-20 h-20' : 'w-16 h-16'} rounded-full flex items-center justify-center text-white transition-all duration-200 ${
            ...
            <div className="text-center">
              ...
              {audioState.isRecording && (
                <p className={`${isMobile ? 'text-xl' : 'text-lg'} font-mono text-red-600`}>
          ...
          <div className="flex flex-col items-center space-y-4 w-full">
            <div className={`flex items-center ${isMobile ? 'space-x-4' : 'space-x-6'}`}>
              <button
                ...
                className={`${isMobile ? 'w-12 h-12' : 'w-10 h-10'} rounded-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center`}
              >
                {isPlaying ? (
                  <Pause className={`${isMobile ? 'w-6 h-6' : 'w-5 h-5'}`} />
                ) : (
                  <Play className={`${isMobile ? 'w-6 h-6 ml-1' : 'w-5 h-5 ml-1'}`} />
                )}
              </button>
