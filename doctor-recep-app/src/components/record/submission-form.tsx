  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 rounded-md p-4">
        <h4 className="text-sm font-medium text-gray-700 mb-3">Ready to Submit:</h4>
        <div className="space-y-2 text-sm text-gray-600">
          <div className="flex items-center justify-between">
            <span>Audio Recording:</span>
            <span className={audioFile ? 'text-green-600 font-medium' : 'text-red-600 font-medium'}>
              {audioFile ? '✓ Ready' : '✗ Required'}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span>Images/Notes:</span>
            <span className={imageFiles && imageFiles.length > 0 ? 'text-green-600 font-medium' : 'text-gray-500'}>
      ...
      {submitStatus === 'idle' && (
        <div className="bg-blue-50 rounded-md p-4">
          <p className="text-sm text-blue-700">
            <strong>Next steps:</strong> After submission, you or your receptionist can review and generate
